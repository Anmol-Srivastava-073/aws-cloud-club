    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#0b0f14]">
        <div className="text-center">
          <h2 className="text-lg font-medium mb-4">Event not found</h2>
  ...
  return (
    <div className="pt-24 pb-20 bg-[#0b0f14] min-h-screen">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <Link
          to="/"
          className="inline-flex items-center gap-2 text-gray-400 hover:text-[#FF9900] mb-8 text-sm"
        >
        ...
        <div className="grid lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-2">
            ...
            {/* Description */}
            <div className="mb-10">
              <h3 className="text-lg font-medium mb-3">About the Event</h3>
                ...
                <div className="grid md:grid-cols-3 gap-4 mt-6">
                  {event.recap.photos.map((img, i) => (
                    <img
                      key={i}
                      src={img}
                      className="rounded-md border border-white/10 object-cover h-44 w-full"
                    />
                  ))}
                </div>
              </div>
          ...
          {/* RIGHT */}
          <div>
            <div className="bg-[#161b22] border border-white/10 rounded-md p-5 sticky top-24">
